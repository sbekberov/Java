...
public class PeriodicView {
    ...
    public final static String MENU =
            "[" + PeriodicView.CASE1 + "] - Отримати список видань для\n" +
                    "заданого виду\n" +
                    "[" + PeriodicView.CASE2 + "] - Отримати список видань, які\n" +
                    "виходять кожен тиждень\n" +
                    "[" + PeriodicView.CASE3 + "] - Отримати список видань вказаного видавництва і ціна яких менше вказаної\n" +
